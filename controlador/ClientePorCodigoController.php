...
class ClientePorCodigoController {
    private $connect;
    private $clientes;
    ...
    public function Buscar($empresa,$codigo)//de las ventas
    {
         $query = "SELECT codigo,cedula_ruc,nombre,direccion1,telefono,e_mail,vendedor,zona from in_cliente where empresa='".$empresa."' and codigo='".$codigo."' order by nombre";
...
$cliente=new ClientePorCodigoController($connect);
$cliente->Buscar($_GET["empresa"],$_GET["codigo"]);