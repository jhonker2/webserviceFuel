...
class DatosProductosProformaController 
{
    ...
    {
         $query = "call web_in_cuerpo_proforma_nefasa('".$empresa."','".$documento."','".$tipo."')";
         ...
         {      
             ...
             $cajas= utf8_encode(odbc_result($result, 20));
             $unidades= utf8_encode(odbc_result($result, 21));
             $fraccion= utf8_encode(odbc_result($result, 22));
             $iva= utf8_encode(odbc_result($result, 23));
             
             $pvp1= utf8_encode(odbc_result($result, 24));
             $pvp2= utf8_encode(odbc_result($result, 25));
             $pvp3= utf8_encode(odbc_result($result, 26));
...
$d=new DatosProductosProformaController($connect);
