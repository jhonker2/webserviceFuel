...
class InventarioFisicoController 
{
    ...
    public function Get($empresa,$documento)
    {
         $query = "call web_in_cuerpo_inv_fisico('".$empresa."','".$documento."','IF')";
...
$caja=new InventarioFisicoController($connect);
$caja->Get($_GET["empresa"],$_GET["documento"]);