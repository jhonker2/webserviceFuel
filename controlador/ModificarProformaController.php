...
class ModificarProformaController 
{
     private $connect;
    ...
    public function ModificarCuerpo($cod_proforma,$empresa,$data)
    {
        ...
        foreach ($decoded as $value)
        {
         ...
         {
             $query ="UPDATE in_movimiento_proforma SET cantidad=".$cantidad.",valor=".$valor.",impuesto=".$impuesto.",lista='".$lista."',valor1=".$valor1.",ubicacion='".$ubicacion."',numprecio='".$lista."',descuento=".$descuento." WHERE empresa='".$empresa."' and secuencia=".$secuencia;
         }
    ...
    {
        $query ="UPDATE in_cabecera_proforma set fecha='".$f_i."',fechav='".$f_f."',pro_cli='".$cod_cliente."',vendedor='".$cod_vendedor."',caja='".$cod_caja."' WHERE empresa='".$empresa."' and tipo='FC' and documento='".$cod_proforma."'";
...
$c=new ModificarProformaController ($connect);
