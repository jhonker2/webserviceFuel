...
class ProveedorCedulaRucController 
{
    private $connect;
    private $proveedores;
    ...
    {
        $query ="SELECT codigo,cedula,nombre,direccion1,ciudad,telefono,e_mail,fax,fuente,iva from in_proveedor where empresa='".$empresa."' and  (substr(cedula,1,10)=substr('".$cedula."',1,10) or codigo='".$cedula."')";
...
$proovedor=new ProveedorCedulaRucController ($connect);
$proovedor->Buscar($_GET["empresa"],$_GET["cedula"]);