...
class ProveedorPorCedulaController 
{
     private $connect;
    private $proveedores;
    ...
    public function InformeProovedores($empresa,$cedula)//de las ventas
    {
         $query = "SELECT codigo,cedula,nombre,direccion1,ciudad,telefono,e_mail,fax,fuente,iva from in_proveedor where empresa='".$empresa."' and cedula='".$cedula."'";
...
$cliente=new ProveedorPorCedulaController($connect);
$cliente->InformeProovedores($_GET["empresa"],$_GET["cedula"]);