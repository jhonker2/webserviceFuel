...
class VentaController {
    ...
    public function InformeVentas($empresa,$inicio,$fin) // de las ventas Informe de Ventas
    {
         $query = "call web_documentos('".$empresa."','FC','".$inicio."','".$fin."','V')";
...
$existencia->InformeVentas($_GET["empresa"],$_GET["inicio"],$_GET["fin"]);
